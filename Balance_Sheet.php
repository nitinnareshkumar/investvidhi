...
<div align="center">
  ...
  <?php 
    ...
    $testcompanySearch=mysql_query("select * from balancesheet where year = '12' and companycode = '$searchCompanyCode'");
	$rows_test = mysql_num_rows($testcompanySearch);
	if ($rows_test == 0 ){
     $companySearch=mysql_query("select * from balancesheet where year = '11' and companycode = '$searchCompanyCode'"); 	 
	$row5 = mysql_fetch_array($companySearch);
	$companySearch=mysql_query("select * from balancesheet where year = '10' and companycode = '$searchCompanyCode'"); 	 
	$row4 = mysql_fetch_array($companySearch);
	$companySearch=mysql_query("select * from balancesheet where year = '09' and companycode = '$searchCompanyCode'"); 	 
	$row3 = mysql_fetch_array($companySearch);
	$companySearch=mysql_query("select * from balancesheet where year = '08' and companycode = '$searchCompanyCode'"); 	 
	$row2 = mysql_fetch_array($companySearch);
	$companySearch=mysql_query("select * from balancesheet where year = '07' and companycode = '$searchCompanyCode'"); 	 
	$row1 = mysql_fetch_array($companySearch);
	}
	else{
	$companySearch=mysql_query("select * from balancesheet where year = '12' and companycode = '$searchCompanyCode'"); 	 
	$row5 = mysql_fetch_array($companySearch);
	$companySearch=mysql_query("select * from balancesheet where year = '11' and companycode = '$searchCompanyCode'"); 	 
	$row4 = mysql_fetch_array($companySearch);
	$companySearch=mysql_query("select * from balancesheet where year = '10' and companycode = '$searchCompanyCode'"); 	 
...
//for sales start ---------------------------------------------------------------------
	...
	$arrayHelpHeading[16];
	$arrayHelpText[16];
	$gethelp = mysql_query("select * from tbl_help where page = 'Balance_Sheet' order by number"); 
 $ihelp=1;
...
<?php 
  ...
  //for eps start ---------------------------------------------------------------------
    ...
    $arrayiTotalIncome[0] = $row1['totalCALoansAdvances'] - $row1['totalClProvisions'];
	$arrayiTotalIncome[1] = $row2['totalCALoansAdvances'] - $row2['totalClProvisions'];
	$arrayiTotalIncome[2] = $row3['totalCALoansAdvances'] - $row3['totalClProvisions'];
	$arrayiTotalIncome[3] = $row4['totalCALoansAdvances'] - $row4['totalClProvisions'];
	$arrayiTotalIncome[4] = $row5['totalCALoansAdvances'] - $row5['totalClProvisions'];
		$patterns =",";
		$replacements1 = '';
		$arrayiTotalIncome[0] = str_replace($patterns,$replacements1,$arrayiTotalIncome[0]);
		$arrayiTotalIncome[1] = str_replace($patterns,$replacements1,$arrayiTotalIncome[1]);
...
<div class="inn_box"  align="center"><a href="Profit_Loss.php?mcode=<? echo $mcode;?>" ><img align="bottom" src="images/profitloss.jpg"  width="100" height="100" border="0" ></a>
