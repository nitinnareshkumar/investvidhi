...
$testcount = 6495;
for ($iLoop= 1; $iLoop<=$row['count'];$iLoop++)
{
...
if(strcmp($content[$i],'P/L Before Int., Excpt. Items & Tax')==0)
{   
...
$salesoutput=mysql_query("insert into temp_sales set companynumber='$singlerow[number]',companycode= '$singlerow[code]',year1='$sales[0]',year2='$sales[1]',year3='$sales[2]',year4='$sales[3]',year5='$sales[4]',growth1='$arraysGrowth[0]',growth2='$arraysGrowth[1]',growth3='$arraysGrowth[2]',growth4='$arraysGrowth[3]',growth5='$arraysGrowth[4]',growthalwayspositive='$spositiveindicator',growthper='$averagesalessum'  ") or die ("Error in query: $query. " . mysql_error());//uncomment

	$operatingprofitoutput=mysql_query("insert into temp_operating_profit set companynumber='$singlerow[number]',companycode= '$singlerow[code]',year1='$operatingprofit[0]',year2='$operatingprofit[1]',year3='$operatingprofit[2]',year4='$operatingprofit[3]',year5='$operatingprofit[4]',growth1='$arrayoGrowth[0]',growth2='$arrayoGrowth[1]',growth3='$arrayoGrowth[2]',growth4='$arrayoGrowth[3]',growth5='$arrayoGrowth[4]',growthalwayspositive='$opositiveindicator',growthper='$averageoperatingprofitsum'  ") or die ("Error in query: $query. " . mysql_error());//uncomment

$epsoutput=mysql_query("insert into temp_eps set companynumber='$singlerow[number]',companycode= '$singlerow[code]',year1='$eps[0]',year2='$eps[1]',year3='$eps[2]',year4='$eps[3]',year5='$eps[4]',growth1='$arrayeGrowth[0]',growth2='$arrayeGrowth[1]',growth3='$arrayeGrowth[2]',growth4='$arrayeGrowth[3]',growth5='$arrayeGrowth[4]',growthalwayspositive='$epositiveindicator',growthper='$averageepssum'  ") or die ("Error in query: $query. " . mysql_error());//uncomment
