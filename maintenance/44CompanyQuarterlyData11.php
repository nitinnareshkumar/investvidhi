...
for ($iLoopCtr= 19081; $iLoopCtr<($iCount+1);$iLoopCtr++)
{
	$result=mysqli_query($link,"select * from name_code where number=$iLoopCtr");
	//$result=mysqli_query($link,"select * from name_code where number=567");
	...
	{	
		...
		//$res=mysqli_query($link,"insert into data_companies_curr set CompNumber='$row[number]',Comp_Code= '$row[code]', Jun_EPS='--',Jun_Operating_Profit='--',Jun_Sales='--',Sep_EPS='--',Sep_Operating_Profit='--',Sep_Sales='--', Dec_EPS='--',Dec_Operating_Profit='--',Dec_Sales='--'");//naidu uncomment
			continue;
	}	
...
//echo "naidu".$year."naidu";
		...
		{
			//$res=mysqli_query($link,"insert into data_companies_curr set CompNumber='$row[number]',Comp_Code= '$row[code]',Jun_EPS='$junEPS',Jun_Operating_Profit='$junOp',Jun_Sales='$junSales',Sep_EPS='$sepEPS',Sep_Operating_Profit='$sepOp',Sep_Sales='$sepSales', Dec_EPS='$decEPS',Dec_Operating_Profit='$decOp',Dec_Sales='$decSales'");	
			//naidu uncomment
		}
