...
//{
	...
	$yearData = strstr($filtered_string1,"<td colspan=1 class=\"detb brdL brdR\" width=\"35%\">&nbsp;</td>");	// This string is repeated before every month	
