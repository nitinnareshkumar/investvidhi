...
for ($iLoop= 7185; $iLoop<($iCount+1);$iLoop++)
{
	...
	if ($dataNotFound!= NULL)
		...
		$res=mysql_query("insert into sales set companynumber='$row[number]',companycode= '$row[code]',Mar11='NA',Mar10='NA',Mar09='NA',Mar08='NA',Mar07='NA',Mar06='NA'");//uncomment
		
		
		$resop=mysql_query("insert into operating_profit set companynumber='$row[number]',companycode= '$row[code]',Mar11='NA',Mar10='NA',Mar09='NA',Mar08='NA',Mar07='NA',Mar06='NA'");//uncomment
		
	
		$reseps=mysql_query("insert into eps set companynumber='$row[number]',companycode= '$row[code]',Mar11='NA',Mar10='NA',Mar09='NA',Mar08='NA',Mar07='NA',Mar06='NA'");//uncomment
			continue;
		}
    ...
    if ($arrayiYear[0]== '12')
		{
			echo "in 12";
		$res=mysql_query("insert into sales set companynumber='$row[number]',companycode= '$row[code]',Mar11='$arrayiSales[1]',Mar10='$arrayiSales[2]',Mar09='$arrayiSales[3]',Mar08='$arrayiSales[4]',Mar07='--',Mar06='--'") or die ("Error in query: $query. " . mysql_error());//uncomment
		
		
		$resop=mysql_query("insert into operating_profit set companynumber='$row[number]',companycode= '$row[code]',Mar11='$arrayiYOperatingProfit[1]',Mar10='$arrayiYOperatingProfit[2]',Mar09='$arrayiYOperatingProfit[3]',Mar08='$arrayiYOperatingProfit[4]',Mar07='--',Mar06='--'");//uncomment
		

		$reseps=mysql_query("insert into eps set companynumber='$row[number]',companycode= '$row[code]',Mar11='$arrayiEps[1]',Mar10='$arrayiEps[2]',Mar09='$arrayiEps[3]',Mar08='$arrayiEps[4]',Mar07='--',Mar06='--'");//uncomment
		
		}
	else if ($arrayiYear[0]== '11')
		{
			
				$res=mysql_query("insert into sales set companynumber='$row[number]',companycode= '$row[code]',Mar11='$arrayiSales[0]',Mar10='$arrayiSales[1]',Mar09='$arrayiSales[2]',Mar08='$arrayiSales[3]',Mar07='$arrayiSales[4]',Mar06='--'");//uncomment
		
		
		$resop=mysql_query("insert into operating_profit set companynumber='$row[number]',companycode= '$row[code]',Mar11='$arrayiYOperatingProfit[0]',Mar10='$arrayiYOperatingProfit[1]',Mar09='$arrayiYOperatingProfit[2]',Mar08='$arrayiYOperatingProfit[3]',Mar07='$arrayiYOperatingProfit[4]',Mar06='--'");//uncomment
		

		$reseps=mysql_query("insert into eps set companynumber='$row[number]',companycode= '$row[code]',Mar11='$arrayiYOperatingProfit[0]',Mar10='$arrayiEps[1]',Mar09='$arrayiEps[2]',Mar08='$arrayiEps[3]',Mar07='$arrayiEps[4]',Mar06='--'");//uncomment
		}
		else if($arrayiYear[0]== '10')
		{
				$res=mysql_query("insert into sales set companynumber='$row[number]',companycode= '$row[code]',Mar11='--',Mar10='$arrayiSales[0]',Mar09='$arrayiSales[1]',Mar08='$arrayiSales[2]',Mar07='$arrayiSales[3]',Mar06='$arrayiSales[4]'");//uncomment
		
		
		$resop=mysql_query("insert into operating_profit set companynumber='$row[number]',companycode= '$row[code]',Mar11='--',Mar10='$arrayiYOperatingProfit[0]',Mar09='$arrayiYOperatingProfit[1]',Mar08='$arrayiYOperatingProfit[2]',Mar07='$arrayiYOperatingProfit[3]',Mar06='$arrayiYOperatingProfit[4]'");//uncomment
		

		$reseps=mysql_query("insert into eps set companynumber='$row[number]',companycode= '$row[code]',Mar11='--',Mar10='$arrayiEps[0]',Mar09='$arrayiEps[1]',Mar08='$arrayiEps[2]',Mar07='$arrayiEps[3]',Mar06='$arrayiEps[4]'");//uncomment	
		}
