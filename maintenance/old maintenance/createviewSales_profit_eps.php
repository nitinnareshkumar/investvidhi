...
/*$result=mysql_query("create or replace View view_SortCompanyBySalesGrowth  AS SELECT * 
...
//-------------------------------------------------------------------------------------------
//need to uncomment when you want to create view 
/*$result1=mysql_query("create or replace View view_SortCompanyByProfitGrowth  AS SELECT * 
...
//-------------------------------------------------------------------------------------------
//need to uncomment when you want to create view 
/*$result2=mysql_query("create or replace View view_SortCompanyByEpsGrowth  AS SELECT * 
...
/*$result3=mysql_query("create or replace View view_SortCompanyByProfitSalesEpsGrowth 
...
//-------------------------------------------------------------------------------------------
// by sales , profit , eps
/*$result4=mysql_query("create or replace View view_SortCompanyBySalesProfitEpsGrowth 
...
/*$result5=mysql_query("create or replace View view_SortCompanyByEpsProfitSalesGrowth  
...
$result=mysql_query("create or replace View view_sortcompanybyQuarter1OPGrowth  AS SELECT * 
FROM  data_companies_curr ORDER BY CAST(  growthOP_qtr2 AS DECIMAL( 10, 2 ) ) DESC ");

//quarter 2 and 3 sales growth
//need to uncomment when you want to create view 
$result=mysql_query("create or replace View view_sortcompanybyQuarter1SalesGrowth  AS SELECT * 
