...
$iCount=7722;//hard coded for fetching 100 records.
// Open error log file
$myFile = "error_logs.txt";
$fh = fopen($myFile, 'a') or die("can't open file");
//loop to parse records
for ($iLoop= 7722; $iLoop<($iCount+1);$iLoop++)
{
...
echo "eps is ".$eps."<br>";	
    ...
    if ($arrayiYear[0]== '15')
		{
			echo "in 12";
		$res=mysql_query("insert into sales set companynumber='$row[number]',companycode= '$row[code]',Mar15='$arrayiSales[0]',Mar14='$arrayiSales[1]',Mar13='$arrayiSales[2]',Mar12='$arrayiSales[3]',Mar11='$arrayiSales[4]' ") or die ("Error in query: $query. " . mysql_error());//uncomment
		
		
		$resop=mysql_query("insert into operating_profit set companynumber='$row[number]',companycode= '$row[code]',Mar15='$arrayiYOperatingProfit[0]',Mar14='$arrayiYOperatingProfit[1]',Mar13='$arrayiYOperatingProfit[2]',Mar12='$arrayiYOperatingProfit[3]',Mar11='$arrayiYOperatingProfit[4]' ") or die ("Error in query: $query. " . mysql_error());//uncomment
		

		$reseps=mysql_query("insert into eps set companynumber='$row[number]',companycode= '$row[code]',Mar15='$arrayiEps[0]',Mar14='$arrayiEps[1]',Mar13='$arrayiEps[2]',Mar12='$arrayiEps[3]',Mar11='$arrayiEps[4]' ") or die ("Error in query: $query. " . mysql_error());//uncomment
		
		}
	else if ($arrayiYear[0]== '14')
		{
			
				$res=mysql_query("insert into sales set companynumber='$row[number]',companycode= '$row[code]', Mar14='$arrayiSales[0]',Mar13='$arrayiSales[1]',Mar12='$arrayiSales[2]',Mar11='$arrayiSales[3]',Mar10='$arrayiSales[4]' ");//uncomment
		
		
		$resop=mysql_query("insert into operating_profit set companynumber='$row[number]',companycode= '$row[code]',Mar14='$arrayiYOperatingProfit[0]',Mar13='$arrayiYOperatingProfit[1]',Mar12='$arrayiYOperatingProfit[2]',Mar11='$arrayiYOperatingProfit[3]',Mar10='$arrayiYOperatingProfit[4]' ");//uncomment
		

		$reseps=mysql_query("insert into eps set companynumber='$row[number]',companycode= '$row[code]',Mar14='$arrayiEps[0]',Mar13='$arrayiEps[1]',Mar12='$arrayiEps[2]',Mar11='$arrayiEps[3]',Mar10='$arrayiEps[4]'  ");//uncomment
		}
		else if($arrayiYear[0]== '13')
		{
				$res=mysql_query("insert into sales set companynumber='$row[number]',companycode= '$row[code]',Mar15='--',Mar13='$arrayiSales[0]',Mar12='$arrayiSales[1]',Mar11='$arrayiSales[2]',Mar10='$arrayiSales[3]',Mar09='$arrayiSales[4]'");//uncomment
		
		
		$resop=mysql_query("insert into operating_profit set companynumber='$row[number]',companycode= '$row[code]',Mar15='--',Mar13='$arrayiYOperatingProfit[0]',Mar12='$arrayiYOperatingProfit[1]',Mar11='$arrayiYOperatingProfit[2]',Mar10='$arrayiYOperatingProfit[3]',Mar09='$arrayiYOperatingProfit[4]'");//uncomment
		

		$reseps=mysql_query("insert into eps set companynumber='$row[number]',companycode= '$row[code]',Mar15='--',Mar13='$arrayiEps[0]',Mar12='$arrayiEps[1]',Mar11='$arrayiEps[2]',Mar10='$arrayiEps[3]',Mar09='$arrayiEps[4]'");//uncomment	
		}
