...
{
	$result=mysqli_query($link, "select * from operating_profit where companynumber= $iCount");
	...
	//echo "<br>";
    $res=mysqli_query($link, "update  operating_profit set GrowthPer='$finalGrowth', growth9_10 = '$arrayiGrowth[0]' , growth10_11 = '$arrayiGrowth[1]', growth11_12= '$arrayiGrowth[2]', growth12_13 = '$arrayiGrowth[3]', growth13_14 = '$arrayiGrowth[4]', growth14_15 = '$arrayiGrowth[5]', growth15_16 = '$arrayiGrowth[6]', growth16_17 = '$arrayiGrowth[7]', growth17_18 = '$arrayiGrowth[8]' , GrowthAlwaysPositive='$positiveindicator' where companynumber = $iCount") or die(mysqli_error()) ;
