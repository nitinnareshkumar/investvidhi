...
$iCount=22193;//hard coded for fetching 100 records.was 7217
// Open error log file
...
for ($iLoop= 22193; $iLoop <($iCount+1);$iLoop++)
{
	...
	echo "error is".mysqli_errno($link) . ": " . mysqli_error($link) . "\n";
	...
	if ($dataNotFound!= NULL)
		...
		//$res=mysqli_query("update sales set Mar15='NA',Mar14='NA',Mar13='NA' where companynumber=$row[number]");//uncomment
...
echo "eps is ".$eps."<br>";	
	...
	for ($iLoop1= 1; $iLoop1< 6 ;$iLoop1++)
	{
		...
		//Naidu Commented - this is not needed - start
		//echo  $iSales;
		/*$arrayiSales[5];
		$arrayiYear[5];	
		$arrayiYrDB[5];
		...
		//Naidu Commented - this is not needed - end
    ...
    if ($arrayiYear[0]== '18')
		{
			echo "in 18";
		$res=mysqli_query($link,"update sales set Mar18='$arrayiSales[0]',Mar17='$arrayiSales[1]',Mar16='$arrayiSales[2]',Mar15='$arrayiSales[3]',Mar14='$arrayiSales[4]' where companynumber='$row[number]' ") or die ("Error in query: $query. " . mysqli_error());//uncomment naidu
		
		
		$resop=mysqli_query($link,"update operating_profit set Mar18='$arrayiYOperatingProfit[0]',Mar17='$arrayiYOperatingProfit[1]',Mar16='$arrayiYOperatingProfit[2]',Mar15='$arrayiYOperatingProfit[3]',Mar14='$arrayiYOperatingProfit[4]' where companynumber='$row[number]' ") or die ("Error in query: $query. " . mysqli_error());//uncomment naidu
		

		$reseps=mysqli_query($link,"update eps set Mar18='$arrayiEps[0]',Mar17='$arrayiEps[1]',Mar16='$arrayiEps[2]',Mar15='$arrayiEps[3]',Mar14='$arrayiEps[4]' where companynumber='$row[number]'") or die ("Error in query: $query. " . mysqli_error());//uncomment naidu
		
		}
	else if ($arrayiYear[0]== '17')
		{
			echo "in 17";
			$res=mysqli_query($link,"update sales set Mar17='$arrayiSales[0]',Mar16='$arrayiSales[1]',Mar15='$arrayiSales[2]',Mar14='$arrayiSales[3]',Mar13='$arrayiSales[4]' where companynumber='$row[number]' ") or die ("Error in query: $query. " . mysqli_error());//uncomment naidu
			
			
			$resop=mysqli_query($link, "update operating_profit set Mar17='$arrayiYOperatingProfit[0]',Mar16='$arrayiYOperatingProfit[1]',Mar15='$arrayiYOperatingProfit[2]',Mar14='$arrayiYOperatingProfit[3]',Mar13='$arrayiYOperatingProfit[4]' where companynumber='$row[number]' ") or die ("Error in query: $query. " . mysqli_error());//uncomment naidu
			

			$reseps=mysqli_query($link,"update eps set Mar17='$arrayiEps[0]',Mar16='$arrayiEps[1]',Mar15='$arrayiEps[2]',Mar14='$arrayiEps[3]',Mar13='$arrayiEps[4]' where companynumber='$row[number]'") or die ("Error in query: $query. " . mysqli_error());//uncomment naidu
		}
		else if($arrayiYear[0]== '16')
		{
			echo "in 16";
			$res=mysqli_query($link,"update sales set Mar16='$arrayiSales[0]',Mar15='$arrayiSales[1]',Mar14='$arrayiSales[2]',Mar13='$arrayiSales[3]',Mar12='$arrayiSales[4]' where companynumber='$row[number]' ") or die ("Error in query: $query. " . mysqli_error());//uncomment naidu
			
			
			$resop=mysqli_query($link, "update operating_profit set Mar16='$arrayiYOperatingProfit[0]',Mar15='$arrayiYOperatingProfit[1]',Mar14='$arrayiYOperatingProfit[2]',Mar13='$arrayiYOperatingProfit[3]',Mar12='$arrayiYOperatingProfit[4]' where companynumber='$row[number]' ") or die ("Error in query: $query. " . mysqli_error());//uncomment naidu
			

			$reseps=mysqli_query($link,"update eps set Mar16='$arrayiEps[0]',Mar15='$arrayiEps[1]',Mar14='$arrayiEps[2]',Mar13='$arrayiEps[3]',Mar12='$arrayiEps[4]' where companynumber='$row[number]'") or die ("Error in query: $query. " . mysqli_error());//uncomment naidu
		}
		...
		else
		{
			...
			fwrite($fh, "$logData\r\n");
			//echo $arrayiYear[$iLoop1-1];
		//$res=mysqli_query($link,"update sales set Mar15='NA',Mar14='NA',Mar13='NA' where companynumber='$row[number]' ");//uncomment naidu
		
		
		//$resop=mysqli_query($link,"update operating_profit set Mar15='NA',Mar14='NA',Mar13='NA' where companynumber='$row[number]' ");//uncomment naidu
		
	
		//$reseps=mysqli_query($link,"update eps set Mar15='NA',Mar14='NA',Mar13='NA' where companynumber='$row[number]' ");//uncomment naidu
		}
